...
namespace virtualSoftKey
{
	partial class frmAbout
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelProductName.Text = "virtualSoftKey";
			...
			this.labelVersion.Text = "Version: 0.2.1";
			...
			this.labelCopyright.Text = "Copyright (c) 2023 ti360gh";
			...
			this.textBoxDescription.Text = "Uses the FSUIPC Client DLL for .NET by Paul Henty  http://fsuipc.paulhenty.com/";
			// 
			// okButton
			// 
			...
			this.linkLabel1.Location = new System.Drawing.Point(3, 72);
			this.linkLabel1.Name = "linkLabel1";
			this.linkLabel1.Size = new System.Drawing.Size(220, 12);
			this.linkLabel1.TabIndex = 25;
			this.linkLabel1.TabStop = true;
			this.linkLabel1.Text = "https://github.com/ti360gh/virtualSoftKey";
